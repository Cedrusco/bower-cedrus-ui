                ...
                var ConstantDirective = (function () {
                    function ConstantDirective($injector) {
                        ...
                        this.link = function (scope, element, attrs) {
                            var isReplace = (scope.replace === 'true');
                            var name = scope.name || attrs['cdConstant'];
                            var key = scope.key;
                            var value;
                            if (attrs['name'] && !name) {
...
})(window, window.angular);;window.cedrusUI={version:{full: "0.2.5"}};