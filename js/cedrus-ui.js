        ...
        (function (components) {
            ...
            (function (dateRangePicker) {
                var DateRangePickerController = (function () {
                    DateRangePickerController.$inject = ["$q", "$element", "$scope"];
                    function DateRangePickerController($q, $element, $scope) {
                        this.$q = $q;
                        this.$element = $element;
                        this.$scope = $scope;
                        this.modelOptions = {};
                    ...
                    DateRangePickerController.prototype.$doCheck = function () {
                        var currentModelOptions = this.$scope.$eval(this.$element.attr('ng-model-options'));
                        if (!angular.equals(this.modelOptions, currentModelOptions)) {
                            this.setNgModelOptions(currentModelOptions);
                        }
                    };
                    DateRangePickerController.prototype.setNgModelOptions = function (newOptions) {
                        this.modelOptions = angular.extend(this.modelOptions, newOptions || {});
                    };
...
})(window, window.angular);;window.cedrusUI={version:{full: "0.3.8"}};