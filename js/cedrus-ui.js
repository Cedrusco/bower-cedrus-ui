            ...
            (function (dateRangePicker) {
                var DateRangePickerController = (function () {
                    ...
                    DateRangePickerController.prototype.$doCheck = function () {
                        var elementScope = this.$element.scope();
                        var currentModelOptions = elementScope.$eval(this.$element.attr('ng-model-options'));
...
})(window, window.angular);;window.cedrusUI={version:{full: "0.3.9"}};