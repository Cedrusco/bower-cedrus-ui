                ...
                var DateRangePickerController = (function () {
                    ...
                    DateRangePickerController.prototype.toggleDateRange = function (form) {
                        if (this.useDateRange) {
                            ...
                            this.onDatepickerChange(this.startDate);
                    ...
                    // animate = (marginBottom) => {
                    // return this.$q((resolve) => {
                    //     this.$dateRangeElement.fadeOut(300, () => {
                    //         resolve();
                    //         this.$dateRangeElement.fadeIn(300);
                    //     });
                    //     this.$dateRangeRow.animate({ 'margin-bottom': marginBottom + 'px' }, 600);
                    // });
                    // }
...
})(window, window.angular);;window.cedrusUI={version:{full: "0.2.29"}};